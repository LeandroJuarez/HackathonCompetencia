...
<body>
<form action="uruguay.php" method="POST">
<header>
...
<div class="container-cover-uruguay">
...
$res=array("Uruguay",$zona,$anio,$sexo,$sector,$comodo,$diver,$dif,$posi,$bull,$comp,$apoyo,$exi,$tareas,$plan);
$cont=1;
